...
FIXME - the text below makes little sense
...
where p is the part the user requires support for. ``lcd_conf.h`` must be located in the application project and not the module. Currently, support is provided for the following screens:
::
	AT043TN24
	K430WQAV4F
